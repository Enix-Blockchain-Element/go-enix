...
var (
	FrontierBlockReward       = big.NewInt(2e+18) // Block reward in wei for successfully mining a block
	...
	calcDifficultyConstantinople = makeDifficultyCalculator(big.NewInt(9223372036854775800))
